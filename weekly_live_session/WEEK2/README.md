...
**1. AI Agent** - Handles reasoning and tool selection

**2. MongoDB Chat Memory** - Stores conversation history outside n8n for persistence and review

**3. MongoDB Atlas Vector Store** - Stores and retrieves embedded knowledge using semantic search

**4. Embeddings Model** - Converts text into vector representations
...
**Persistence** - All state survives workflow restarts

**Auditability** - Conversations and retrievals can be reviewed

**Scalability** - MongoDB handles growth in data and usage

**Separation of Concerns** - Memory, knowledge, and reasoning are distinct

**Infrastructure** - Data lives in proper databases, not workflow memory
